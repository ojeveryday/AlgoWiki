...
| 题目                                                         | 提示                                   |
| ------------------------------------------------------------ | -------------------------------------- |
| [34. 在排序数组中查找元素的第一个和最后一个位置](https://leetcode-cn.com/problems/find-first-and-last-position-of-element-in-sorted-array/) | 非常好的使用模板二的练习。             |
...
| 题目                                                         | 提示               |
| ------------------------------------------------------------ | ------------------ |
| [287. 寻找重复数](https://leetcode-cn.com/problems/find-the-duplicate-number/) | 需要结合抽屉原理。 |
